...
// TODO: ShrinkingMap is borrowed from https://github.com/iotaledger/hive.go/pull/360
// should removed and update hive.go once the ShrinkingMap is merged
// ShrinkingMap provides a non concurrent-safe map that shrinks if the ratio between the amount of deleted keys and the
// map's size grows bigger than a configurable threshold.
