...
// TODO: ShrinkingMap is borrowed from https://github.com/iotaledger/hive.go/tree/feat/generic
// should removed and update hive.go once the ShrinkingMap is merged into main branch
