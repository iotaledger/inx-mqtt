...
require (
	...
	github.com/iotaledger/hive.go/web v0.0.0-20230912172434-dc477e1f5140 // indirect
	github.com/iotaledger/inx-app v1.0.0-rc.3.0.20230921141002-9dba81c178ad // indirect
