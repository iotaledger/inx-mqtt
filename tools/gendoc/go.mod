...
require (
	...
	github.com/iotaledger/inx-app v1.0.0-rc.3.0.20230906120020-eb566076caf6 // indirect
	github.com/iotaledger/inx/go v1.0.0-rc.2.0.20230904035052-54cba612a7bb // indirect
